...
test3_:
   ...
   mov     rax, QWORD PTR [rax] /* assign from ref z */
   mov     rbx,  QWORD PTR -16[rbp]
   mov     QWORD PTR [rbx], rax /* assign ref z */
   mov     rax, QWORD PTR -16[rbp] /*z*/
   push    rax
...
test2_:
   ...
   mov     rax, QWORD PTR [rax] /* assign from ref y */
   mov     rbx,  QWORD PTR -24[rbp]
   mov     QWORD PTR [rbx], rax /* assign ref z */
   mov     rax, QWORD PTR -24[rbp] /*z*/
   push    rax
